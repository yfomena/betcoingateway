...
export class PronosticService {
    ...
    private resourceUrl =  SERVER_API_URL + 'betcoinapi/api/pronostics';
    ...
    private convertItemFromServer(pronostic: Pronostic): Pronostic {
        ...
        copy.pronoDate = this.dateUtils
            .convertDateTimeFromServer(pronostic.pronoDate);
        return copy;
    }
    ...
    private convert(pronostic: Pronostic): Pronostic {
        ...
        copy.pronoDate = this.dateUtils.toDate(pronostic.pronoDate);
        return copy;
    }
}
